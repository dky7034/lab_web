...
<html>
	...
	<body>
		<h1>EL(Expression Language): 표현식 언어</h1>
		<%--
		  EL: JSP의 expression(식) 태그 <%= ... %>을 대체하는 문법.
		  문법: ${ 식 }
		  * 지시문 <%@ ... %> 안에서는 사용할 수 없음.
		  * 선언문 <%! ... %> 안에서는 사용할 수 없음.
		  * 스크립트릿 <% ... %> 안에서는 사용할 수 없음.
