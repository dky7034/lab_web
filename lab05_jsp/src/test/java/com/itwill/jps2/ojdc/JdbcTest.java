 ...
 * Run As -> JUnit Test를 실행하면, junit-jupiter-engine에서 테스트 메서드를 실행. (이 엔진이 메인 메서드를 가지고 있음)
 */
public class JdbcTest {
	 ...
	 * 테스트 메서드 작성:
	 * @Test 애너테이션을 사용.
	 * public void로 선언. (테스트 엔진이 보고 실행해야 하니까)
	 * 파라미터를 선언하지 않아야 함.
	 */
	@Test
	public void test() throws SQLException{
		...
		// Assertions: 개발자가 테스트 성공/실패를 설정, 처리하고 싶을 때 사용하는 클래스
